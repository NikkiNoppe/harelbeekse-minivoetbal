-- WORKING RLS POLICIES - IMMEDIATE FIX
-- This solution first removes all restrictions, then implements working policies

-- Step 1: Disable RLS temporarily to clear all restrictions
...
-- Step 4: Create simple working policies that actually work
