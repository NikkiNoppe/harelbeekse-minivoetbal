-- Boetes (o.a. Forfait verwittigd) via app: admins + scheidsrechter voor de betreffende wedstrijd.
-- Na insert van een forfait-boete: alle actieve match_cost-regels voor die wedstrijd verwijderen.
...
BEGIN
  ...
  IF v_category = 'penalty'
     ...
     AND lower(trim(v_cost_name)) LIKE '%forfait%' THEN
