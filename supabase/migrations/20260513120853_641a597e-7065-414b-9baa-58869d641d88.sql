...
GRANT EXECUTE ON FUNCTION public.add_team_cost_as_admin(integer, integer, integer, numeric, date, integer) TO authenticated;
GRANT EXECUTE ON FUNCTION public.add_team_cost_as_admin(integer, integer, integer, numeric, date, integer) TO service_role;