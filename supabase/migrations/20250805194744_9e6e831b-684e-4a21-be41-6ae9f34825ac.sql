-- Update the process_match_financial_costs function to include amount field
...
-- Update existing team_costs records that have NULL amounts
UPDATE public.team_costs 
SET amount = costs.amount 
FROM public.costs 
WHERE team_costs.cost_setting_id = costs.id 
