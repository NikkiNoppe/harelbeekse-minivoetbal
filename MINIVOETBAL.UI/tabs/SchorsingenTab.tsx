...
import type { Suspension, PlayerCard } from "../../MINIVOETBAL.SERVICES/suspensionService";
...
const SuspensionRules = memo(() => {
  ...
  useEffect(() => {
    const loadRules = async () => {
      try {
        const { suspensionRulesService } = await import("../../MINIVOETBAL.SERVICES/suspensionRulesService");
