...
import CompetitionManagementTab from '../admin/tabs/CompetitionManagementTab';
import FinancialTabUpdated from '../admin/tabs/FinancialTabUpdated';
import UserManagementTab from '../admin/tabs/UserManagementTab';
import TeamsTab from '../admin/tabs/TeamsTab';
import MatchFormTab from '../team/MatchFormTab';
import CupTournamentManager from '../admin/CupTournamentManager';
import PlayoffManagementTab from '../admin/tabs/PlayoffManagementTab';
