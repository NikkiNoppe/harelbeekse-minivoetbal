...
import MonthlyReportsModal from '../financial/MonthlyReportsModal';
import { costSettingsService } from '../../../../MINIVOETBAL.SERVICES/financial/costSettingsService';
import { financialOverviewService } from '../../../../MINIVOETBAL.SERVICES/financial/financialOverviewService';
import type { TeamTransaction } from '../../../../MINIVOETBAL.SERVICES/financial/costSettingsService';
...
const FinancialTabUpdated: React.FC = () => {
  ...
  const { data: allTransactions } = useQuery({
    ...
    queryFn: async () => {
      ...
      const allTransactions: TeamTransaction[] = [];
