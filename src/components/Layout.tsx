      ...
      <header className="w-full py-4 px-6 shadow-md soccer-pattern">
        <div className="container flex justify-between items-center">
          <div className="flex items-center gap-3 cursor-pointer" onClick={handleLogoClick} role="button" aria-label="Go to home page">
            ...
            <div>
              <h1 className="text-foreground text-lg font-bold tracking-tight md:text-lg">Harelbeekse Minivoetbal</h1>
              <p className="text-foreground/80 text-xs md:text-sm">Competitie</p>
            </div>
          </div>
