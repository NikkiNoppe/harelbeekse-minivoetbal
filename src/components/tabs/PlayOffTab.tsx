...
const PlayOffTab: React.FC = () => {
  const playoffTeams = {
    playoff1: [
      { position: 1, name: "CAFE DE GILDE", played: 29, won: 22, draw: 3, lost: 4, goalsFor: 228, goalsAgainst: 102, goalDiff: 126, points: 70 },
      { position: 2, name: "GARAGE VERBEKE", played: 29, won: 23, draw: 5, lost: 1, goalsFor: 229, goalsAgainst: 101, goalDiff: 128, points: 70 },
      { position: 3, name: "BEMARMI BOYS", played: 29, won: 21, draw: 6, lost: 2, goalsFor: 184, goalsAgainst: 89, goalDiff: 95, points: 65 },
      { position: 4, name: "DE FLORRE", played: 29, won: 16, draw: 10, lost: 3, goalsFor: 218, goalsAgainst: 130, goalDiff: 88, points: 51 },
      { position: 5, name: "DE DAGERAAD", played: 29, won: 15, draw: 12, lost: 2, goalsFor: 154, goalsAgainst: 95, goalDiff: 59, points: 47 },
      { position: 6, name: "SHAKTHAR TRU.", played: 29, won: 12, draw: 13, lost: 4, goalsFor: 124, goalsAgainst: 122, goalDiff: 2, points: 40 }
    ]
  };
  ...
  const playoffMatches = [
    ...
    // New results
    { playoff: "Play-Off 1", matchday: "Speeldag 3", date: "12 mei", home: "Shakthar Tru.", away: "De Florre", result: "0-5", location: "Sportpark Oost" },
    { playoff: "Play-Off 1", matchday: "Speeldag 3", date: "12 mei", home: "Cafe De Gilde", away: "Bemarmi Boys", result: "4-4", location: "Sportpark Zuid" },
    { playoff: "Play-Off 1", matchday: "Speeldag 3", date: "13 mei", home: "Garage Verbeke", away: "De Dageraad", result: "5-1", location: "Sportpark Noord" }
  ];
  ...
  return (
    <div className="space-y-10 animate-slide-up">
      ...
      <section>
        <h2 className="text-2xl font-semibold mb-8">Uitslagen Play-Offs</h2>
