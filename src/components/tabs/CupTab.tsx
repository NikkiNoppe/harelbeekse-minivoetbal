  ...
  return <div className="space-y-8 animate-slide-up">
        ...
        <Card>
          ...
          <CardContent>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
              {bracketData.eighthfinals.map(match => <MatchCard key={match.id} id={match.id} home={match.home} away={match.away} date={match.date} time={match.time} location={match.location} status={match.status as MatchCardStatus} nextMatch={match.nextMatch} />)}
            </div>
          </CardContent>
        </Card>
      </section>
      ...
      <section>
        <Card>
          ...
          <CardContent>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
              {bracketData.quarterfinals.map(match => <MatchCard key={match.id} id={match.id} home={match.home} away={match.away} date={match.date} time={match.time} location={match.location} status={match.status as MatchCardStatus} nextMatch={match.nextMatch} />)}
            </div>
          </CardContent>
        </Card>
      </section>
        ...
        <Card>
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {bracketData.semifinals.map(match => <MatchCard key={match.id} id={match.id} home={match.home} away={match.away} date={match.date} time={match.time} location={match.location} status={match.status as MatchCardStatus} nextMatch={match.nextMatch} />)}
            </div>
          </CardContent>
        </Card>
      </section>
        ...
        <Card>
          ...
          <CardContent>
            <div className="max-w-md mx-auto">
              <MatchCard id={bracketData.final.id} home={bracketData.final.home} away={bracketData.final.away} date={bracketData.final.date} time={bracketData.final.time} location={bracketData.final.location} status={bracketData.final.status as MatchCardStatus} />
            </div>
          </CardContent>
        </Card>
      </section>
