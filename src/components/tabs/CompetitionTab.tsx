...
import ResponsiveCompetitionTable from "@/components/tables/ResponsiveCompetitionTable";
        ...
        <Card>
          <CardContent className="bg-transparent p-4 sm:p-6">
            {isLoading && !teams ? (
              ...
              <ResponsiveCompetitionTable teams={teamsToDisplay} />
            )}
          </CardContent>
        </Card>
      </section>
                ...
                <Select value={selectedMatchday} onValueChange={setSelectedMatchday}>
                  ...
                  <SelectContent className="dropdown-content-login-style">
                    ...
                    {matchdays.map((day, idx) => (
                      <SelectItem key={idx} value={day} className="dropdown-item-login-style">{day}</SelectItem>
                    ))}
                  </SelectContent>
                </Select>
              </div>
