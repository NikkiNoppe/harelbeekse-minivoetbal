  ...
  return <footer className="bg-purple-300 py-4 sm:py-6 mt-auto">
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 sm:gap-8">
          <div>
            <h3 className="font-semibold text-purple-dark mb-2 sm:mb-3 text-sm sm:text-base">Harelbeekse Minivoetbal Competitie - v1.251204</h3>
          ...
          <div>
            ...
            <div className="space-y-1">
              ...
              <p className="text-xs text-white sm:text-sm">+32 468 15 52 16</p>
            </div>
          </div>
        </div>
