      ...
      <section className="space-y-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Automatische selectie van top/bottom op basis van de stand. Kies het aantal rondes en de periode.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-6">
            ...
            <div className="flex gap-4">
              <Button
                ...
                disabled={loading || !startDate || !endDate || (selectedTopTeams.length === 0 && selectedBottomTeams.length === 0)}
                className="flex-1"
              >
                {loading ? (
              ...
              {hasPlayoffMatches && (
                <Button variant="destructive" onClick={handleDeletePlayoffs} disabled={loading}>
            ...
            <Alert>
              ...
              <AlertDescription>
                Playoffs worden gepland met max. 7 speelmomenten per week en rekening houdend met vakanties en bekers.
              </AlertDescription>
            </Alert>
          </CardContent>
        </Card>
          ...
          <CardHeader>
            <div className="flex justify-between items-center">
              <div>
                ...
                <CardDescription>Bekijk en beheer playoff wedstrijden</CardDescription>
              </div>
              {hasPlayoffMatches && (
                <Button variant="destructive" onClick={handleDeletePlayoffs} disabled={loading}>
                  <Trash2 className="h-4 w-4 mr-2" />
          ...
          <CardContent>
            {loading ? (
              ...
              <div className="text-center py-8">
                ...
                <p className="text-muted-foreground">
                  Er zijn nog geen playoff wedstrijden gegenereerd. Gebruik de knop hierboven om playoffs aan te maken.
                </p>
              </div>
            )}
          </CardContent>
