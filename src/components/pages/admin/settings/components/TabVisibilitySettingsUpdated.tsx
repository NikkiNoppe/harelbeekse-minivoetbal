...
const TAB_GROUPS = [
  {
    id: 'menu',
    title: 'Informatie',
    description: "Publieke navigatie op de website",
    icon: Globe,
    tabs: ['algemeen', 'reglement', 'competitie', 'beker', 'playoff', 'kaarten', 'archief'],
  },
  {
    id: 'wedstrijden',
    title: 'Wedstrijden',
    description: 'Wedstrijdformulieren voor ingelogde rollen',
    icon: ClipboardList,
  ...
  },
  {
    id: 'beheer',
    title: 'Beheer',
    description: "Beheerpagina's voor admin en superadmin",
    icon: Settings,
  ...
  },
  {
    id: 'planning',
    title: 'Planning',
    description: 'SuperAdmin-planning voor competitie, beker en play-off',
    icon: Trophy,
