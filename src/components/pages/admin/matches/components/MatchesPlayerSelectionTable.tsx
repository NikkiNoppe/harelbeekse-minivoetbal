                  ...
                  {canEdit ? (
                    <Select
                      ...
                      onValueChange={useCallback((value) =>
                        onPlayerSelection(index, 'playerId', value === "no-player" ? null : parseInt(value), false), [index, onPlayerSelection])}
                      disabled={!canEdit}
                    >
                        ...
                        {players && typeof Array.isArray === 'function' && Array.isArray(players) &&
                          players.map((player) => {
                            ...
                            const alreadySelected =
                              memoizedSelectedPlayerIds.includes(playerIdNum) &&
                    ...
                    {canEdit && selection.playerId ? (
                      ...
                      >
                        ...
                        <SelectContent className="dropdown-content-login-style">
                          ...
                          <SelectItem value="yellow" className="dropdown-item-login-style"><span className="flex items-center"><MatchesCardIcon type="yellow" /><span className="ml-1">Geel</span></span></SelectItem>
                          <SelectItem value="double_yellow" className="dropdown-item-login-style"><span className="flex items-center"><MatchesCardIcon type="double_yellow" /><span className="ml-1">2x Geel</span></span></SelectItem>
                          <SelectItem value="red" className="dropdown-item-login-style"><span className="flex items-center"><MatchesCardIcon type="red" /><span className="ml-1">Rood</span></span></SelectItem>
                        </SelectContent>
                      </Select>
                    ) : (
                      <MatchesCardIcon type={playerCards[selection.playerId!] as any || "none"} />
