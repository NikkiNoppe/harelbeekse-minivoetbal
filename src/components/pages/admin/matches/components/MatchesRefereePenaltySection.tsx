...
export const MatchesRefereePenaltySection: React.FC<any> = (props) => {
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                ...
                >
                  ...
                  <SelectContent>
                    <SelectItem value={props.match.homeTeamId.toString()}>
                      {props.match.homeTeamName}
                    </SelectItem>
                    <SelectItem value={props.match.awayTeamId.toString()}>
